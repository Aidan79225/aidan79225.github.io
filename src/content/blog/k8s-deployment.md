...
我很吃這一套。以前部署是件要挑半夜、全員待命、深怕中斷服務的大事;有了 Deployment 的滾動更新 + 一鍵回滾,部署變成**低風險的日常動作** —— 新版慢慢頂替、出包秒退。這跟我在 [[airflow-scheduling|Airflow]] 那篇講的「生產作業要冪等、可重跑」是同一種安全感:**讓「改變」變得可逆、可控,人就敢頻繁地小步前進**,而不是攢一大包、賭一次大的。
