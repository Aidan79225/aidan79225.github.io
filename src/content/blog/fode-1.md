...
書裡「多數人該先當 A 型工程師」的主張,跟我在每一篇工具筆記的結論驚人地一致 —— 我寫 [[airflow-intro|Airflow]]、[[spark-running|Spark]]、[[kafka-intro|Kafka]] 都在說同一句話:**[[pain-before-power|先確認痛點到了那個量級,再上重武器]];能用託管/現成的就別自架。** 造輪子的衝動很迷人,但「沒有差異化的粗活」自己扛,往往只是把維運債堆給未來的自己。B 型的時機是規模逼出來的,不是拿來證明技術力的。
