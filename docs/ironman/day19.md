...
- **banned user 表用 content type + object id**——泛型外鍵在這個系統第三次出場(購物車來源、留言溯源之後,這次是封鎖主體):要封 fb user 封 fb user、要封 account 封 account,一張表通吃。**連坐是 account 級的**:封了帳號,名下綁定的身份一起生效;而且綁定的瞬間會更新 Redis——**新身份綁上被封的帳號,當場繼承前科**。當然,身份的天生限制還在:換一張全新的臉(新 FB 帳號)有時就是擋不住——這是 Day 6 講過的老實話,風控只能提高成本,不能消滅匿名。
